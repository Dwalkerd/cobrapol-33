  ...
  const marcos = [
    {
      ...
      descricao:
        "Fundada em 9 de outubro de 1991 pela iniciativa de sindicalistas estaduais para dar voz unificada aos policiais civis em todo o Brasil.",
    },
    {
      ano: "1993",
      titulo: "Registro como Confederação",
      descricao:
        "Formalização junto ao Ministério do Trabalho e Emprego como confederação sindical com CNPJ 37.050.804/0001-05.",
    },
    {
      ano: "1995",
      titulo: "Primeiros Congressos Nacionais",
      descricao:
        "Estabelecimento dos congressos nacionais como órgão máximo deliberativo, reunindo delegados de todos os estados.",
    },
    {
      ano: "2000",
      titulo: "Expansão das Federações",
      descricao:
        "Organização das federações regionais (Norte, Nordeste, Sudeste, Sul e Centro-Oeste) fortalecendo a representação nacional.",
    },
    {
      ano: "2007",
      titulo: "Lei Orgânica Nacional",
      descricao:
        "Início da articulação política para aprovação da Lei Orgânica Nacional das Polícias Civis (PL 1.949/2007).",
    },
    {
      ano: "2018",
      titulo: "Atuação no STF",
      descricao:
        "Participação como amicus curiae em processos no Supremo Tribunal Federal defendendo direitos previdenciários da categoria.",
    },
    {
      ano: "2020",
      titulo: "Saúde Mental",
            ...
            <div className="space-y-8 text-background">
              <div className="space-y-4">
                ...
                <p className="text-xl text-background/90 max-w-lg">
                  Conheça a COBRAPOL: mais de 30 anos defendendo os direitos dos policiais civis brasileiros. Nossa
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              ...
              a maior entidade representativa dos policiais civis no Brasil. Com 34 anos de atuação, nasceu com o
              propósito de unificar sindicatos e federações estaduais e, desde então, atua nacionalmente na defesa dos
              direitos, garantias e interesses da categoria, promovendo valorização profissional, justiça social e
              fortalecimento das instituições policiais.
            </p>
            <p className="text-lg text-muted-foreground max-w-4xl mx-auto mt-6 leading-relaxed">
              Ao longo de sua história, a Cobrapol se consolidou como uma voz ativa e legítima nos debates sobre
              segurança pública, dialogando com os poderes Executivo, Legislativo e Judiciário. Mais do que representar,
              a entidade mobiliza, articula e transforma, garantindo que os policiais civis de todo o país tenham
              protagonismo nas decisões que impactam sua carreira e a sociedade.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <Card className="text-center group hover:shadow-lg transition-all duration-300 border-gold/20 hover:border-gold/40">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Representar e fortalecer os policiais civis do Brasil, promovendo a valorização da carreira, a defesa
                  dos direitos trabalhistas e previdenciários, e a construção de uma segurança pública cidadã, moderna e
                  eficiente.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center group hover:shadow-lg transition-all duration-300 border-gold/20 hover:border-gold/40">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  <strong>Unidade</strong> – União da categoria em todo o território nacional. <strong>Compromisso</strong> – Dedicação à defesa dos policiais civis e da sociedade. <br />
                  <strong>Transparência</strong> – Gestão ética, responsável e participativa. <strong>Respeito</strong> – Valorização da diversidade e da dignidade humana. <strong>Justiça</strong> – Promoção da igualdade de direitos e de melhores condições de trabalho.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center group hover:shadow-lg transition-all duration-300 border-gold/20 hover:border-gold/40">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Filiar-se à Cobrapol é unir forças em uma luta coletiva que transcende fronteiras estaduais. Ganha
                  representatividade nacional, fortalece a defesa de direitos e contribui para um movimento sindical
                  forte que propõe soluções e transforma realidades.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="bg-card rounded-3xl p-8 lg:p-12 border border-gold/20 mb-16">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-3xl font-bold mb-6 text-foreground">Nossa Trajetória de Lutas e Conquistas</h3>
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Fundação em 9 de outubro pela iniciativa de sindicalistas para unir os policiais civis do
                        Brasil.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Registro como confederação e organização das federações regionais.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Lei Orgânica Nacional e atuação como amicus curiae no STF.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Programas de saúde mental e modernização da representação sindical.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">
                A Cobrapol também lidera grandes mobilizações nacionais em defesa da categoria, como nas discussões
                sobre a Reforma da Previdência, na articulação para a aprovação da Lei Orgânica Nacional das Polícias
                Civis e na luta pela PEC da Segurança Pública. Essas batalhas simbolizam o compromisso da entidade em
                garantir não apenas melhores condições de trabalho e valorização salarial, mas também a preservação de
                direitos históricos que asseguram dignidade e justiça aos policiais civis de todo o Brasil.
              </p>
              <p className="text-muted-foreground">
                A Cobrapol é mais do que uma confederação: é a voz, a força e a união dos policiais civis de todo o
                Brasil. Filiar-se à Cobrapol significa integrar uma rede articulada de sindicatos que compartilham
                experiências, estratégias e conquistas, tendo acesso a suporte político e institucional em pautas locais
                e nacionais.
              </p>
            </CardContent>
          </Card>
